...
const AskQuestionScreen = ({ navigation }) => {
  ...
  const handleAskQuestion = () => {
    ...
    Alert.alert(
      'Question Submitted',
      'Your question has been submitted successfully! Teachers will review and answer it soon.',
      [
        {
          text: 'OK',
        ...
        <View style={styles.formContainer}>
            ...
            <View style={styles.subjectContainer}>
              {subjects.map((subj, index) => (
                <TouchableOpacity
                  ...
                  style={[
                    styles.subjectChip,
                    subject === subj && styles.selectedSubjectChip
                  ]}
                  onPress={() => setSubject(subj)}
                >
                  <Text style={[
                    styles.subjectChipText,
                    subject === subj && styles.selectedSubjectChipText
                  ]}>
                    {subj}
                  </Text>
                </TouchableOpacity>
          ...
          <View style={styles.inputContainer}>
            ...
            <TextInput
              ...
              placeholder="Type your question here... Be specific and clear so teachers can provide the best answer."
              multiline
              numberOfLines={8}
          ...
          <View style={styles.tipsContainer}>
            ...
            <View style={styles.tipItem}>
              <MaterialIcons name="check-circle" size={16} color="#4CAF50" />
              <Text style={styles.tipText}>Include relevant context or examples</Text>
            </View>
            <View style={styles.tipItem}>
              <MaterialIcons name="check-circle" size={16} color="#4CAF50" />
              <Text style={styles.tipText}>Check if your question has already been answered</Text>
            </View>
          </View>
